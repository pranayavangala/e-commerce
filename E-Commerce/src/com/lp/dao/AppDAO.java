...
public class AppDAO {
	...
	public static int deleteTransaction(int userid){
		
		int result = 0;
		
		try{
			
			PreparedStatement ps = MyConnection.getConnection().prepareStatement("delete form transactions where userid = ?");
	...
	public static int updateTransaction(int tid,String status){
		
		int result = 0;
		
		try{
			
			PreparedStatement ps = MyConnection.getConnection().prepareStatement("update transactions set status=? where id = ?");
